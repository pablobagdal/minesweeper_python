...
Создание игрового движка: Вы разработаете надежную основу для игры, используя классы и списки для моделирования игрового поля.

Реализация детерминированного решателя: Вы напишете модуль, который делает логически безупречные выводы, используя множества и словари для эффективной обработки ограничений.
